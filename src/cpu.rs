pub struct Cpu {
    ...
    pub i: u16,             //used to store memory addresses
    pub pc: u16,
    pub stack: [u16; 16], //used to store the address that the interpreter should return to when finished with a subroutine
    pub sp: u8, //The stack pointer (SP) can be 8-bit, it is used to point to the topmost level of the stack
    pub delay_timer: u8,
    pub sound_timer: u8,
